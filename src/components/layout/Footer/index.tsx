...
export default function Footer({ city, coords, useGeo }: FooterProps) {
    const cityQuery = useWeather(city);
    const coordsQuery = useWeatherByCoords(coords?.lat, coords?.lon);
            ...
            <div className={styles.container}>
                <div className={styles.cart}>
                    ...
                    <div className={styles.sub}>
                        ...
                        <img
                            src='../../../../public/icons/icon-Sunrise.svg'
                            alt='Sunrise'
                        />
                    </div>
                </div>
                ...
                <div className={styles.cart}>
                    ...
                    <div className={styles.sub}>
                        ...
                        <img
                            src='../../../../public/icons/icon-Sunset.svg'
                            alt='Sunset'
                        />
                    </div>
                </div>
                ...
                <div className={styles.cart}>
                    ...
                    <div className={styles.sub}>
                        ...
                        <img
                            src='../../../../public/icons/icon-Raindrop.svg'
                            alt='Precipitation'
                        />
                    </div>
                </div>
                ...
                <div className={styles.cart}>
                    ...
                    <div className={styles.sub}>
                        ...
                        <img
                            src='../../../../public/icons/icon-Exclusion.svg'
                            alt='Humidity'
                        />
                    </div>
                </div>
                ...
                <div className={styles.cart}>
                    ...
                    <div className={styles.sub}>
                        ...
                        <img
                            src='../../../../public/icons/icon-Wind.svg'
                            alt='Wind'
                        />
                    </div>
                </div>
                ...
                <div className={styles.cart}>
                    ...
                    <div className={styles.sub}>
                        ...
                        <img
                            src='../../../../public/icons/icon-Group.svg'
                            alt='Pressure'
                        />
                    </div>
                </div>
                ...
                <div className={styles.cart}>
                    ...
                    <div className={styles.sub}>
                        ...
                        <img
                            src='../../../../public/icons/icon-Temperature.svg'
                            alt='Feels like'
                        />
                    </div>
                </div>
                ...
                <div className={styles.cart}>
                    ...
                    <div className={styles.sub}>
                        ...
                        <img
                            src='../../../../public/icons/icon-Visibility.svg'
                            alt='Visibility'
                        />
                    </div>
                </div>
